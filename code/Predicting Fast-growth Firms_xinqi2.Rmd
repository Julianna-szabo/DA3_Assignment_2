...
Table 10 shows that the 0.5 threshold leads to a higher accuracy rate than 0.25 and a higher specificity rate. At the same time, the 0.25 threshold results in higher sensitivity.
